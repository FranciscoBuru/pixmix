      ...
      <header className="border-b border-slate-200 bg-white/85 backdrop-blur sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://github.com/FranciscoBuru/pixmix"
              target="_blank"
              rel="noreferrer"
              className="text-sm font-semibold text-slate-700 border border-slate-200 bg-white rounded-lg px-3 py-2 shadow-sm hover:bg-slate-50 transition inline-flex items-center gap-2"
            >
              <svg aria-hidden="true" viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
                <path d="M8 0C3.58 0 0 3.58 0 8a8 8 0 0 0 5.47 7.59c.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.01.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.11.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.45.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8Z" />
              </svg>
              Repo
            </a>
          </div>
            ...
            <div className="border border-slate-200 rounded-xl p-5 bg-white shadow-sm relative overflow-hidden lift-on-hover">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-emerald-100 bg-emerald-50/60 text-emerald-800 text-xs font-medium px-3 py-2 rounded-lg flex items-center gap-2">
                  <span className="h-2 w-2 rounded-full bg-emerald-500" />
                  Fast mode enabled (Greedy matching).
                </div>
              </div>
            </div>
